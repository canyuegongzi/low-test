...
const SingleMonacoEditor = forwardRef((props: ISingleMonacoEditorProps, ref) => {
  ...
  return (
    <div className={className} style={props.style}>
      ...
      {/*// @ts-ignore*/}
      <div ref={containerRef} className="react-monaco-editor-container" style={isFullScreen ? fullScreenStyle : style}>
...
const DiffMonacoEditor = (props: IDiffMonacoEditorProps) => {
  ...
  return (
    <div className={className} style={props.style}>
      {loading && <span className="loading">{WORD_EDITOR_INITIALIZING}</span>}
      {/*// @ts-ignore*/}
      <div ref={containerRef} className="react-monaco-editor-container react-monaco-editor-diff-container" style={style}/>
    </div>
  );
};
